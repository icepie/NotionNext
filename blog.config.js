...
const BLOG = {
  AUTHOR: 'icepie', // 作者
  BIO: '待会去码头整点薯条', // 作者简介
  LINK: 'https://blog.icepie.net', // 网站地址
  KEYWORDS: 'Notion, 博客, icepie, 平均律', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '80071ce458464a39b647727ad569dc9a', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  SINCE: 1027, // e.g if leave this empty, current year will be used.
  ...
  CONTACT_EMAIL: 'icepie.dev@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/icepie', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/icepie', // 你的telegram 地址 例如 https://t.me/tangly_1024
